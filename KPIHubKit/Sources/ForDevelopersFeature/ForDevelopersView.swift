...
public struct ForDevelopersView: View {
    struct ViewState: Equatable {
        init(state: ForDevelopersFeature.State) { }
    }
    @ObservedObject private var viewStore: ViewStore<ViewState, ForDevelopersFeature.Action.View>
    
    public init(store: StoreOf<ForDevelopersFeature>) {
    ...
    public var body: some View {
        ...
        .background(Theme.default.screenBackgroundColor)
...
#Preview {
    ForDevelopersView(
        store: Store(
            initialState: ForDevelopersFeature.State()
        ) {
